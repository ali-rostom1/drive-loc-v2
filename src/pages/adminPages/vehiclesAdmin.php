        ...
        <div id="editModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
            <div class="bg-gray-400 rounded-lg shadow-lg w-3/4 md:w-1/2">
                <form id="editForm" class="p-6 space-y-4">
                    ...
                    <div>
                        <label for="editModel" class="block text-sm font-medium">Model</label>
                        <input type="text" id="editModel" name="model" class="w-full px-4 py-2 border rounded">
                    </div>
                    <div>
                        <label for="editBrand" class="block text-sm font-medium">Brand</label>
                        <input type="text" id="editBrand" name="brand" class="w-full px-4 py-2 border rounded">
                    </div>
                    <div>
                        <label for="editPrice" class="block text-sm font-medium">Price</label>
                        <input type="number" id="editPrice" name="price" class="w-full px-4 py-2 border rounded">
                    </div>
                    <div>
                        <label for="editLocation" class="block text-sm font-medium">Location</label>
                        <input type="text" id="editLocation" name="location" class="w-full px-4 py-2 border rounded">
                    </div>
                    <div>
                        <label for="editAvailable" class="block text-sm font-medium">Available</label>
                        <select id="editAvailable" name="isAvailable" class="w-full px-4 py-2 border rounded">
                            <option value="1">Yes</option>
                            <option value="0">No</option>
                        </select>
                    </div>
                    <div>
                        <label for="editCategory" class="block text-sm font-medium">Available</label>
                        <select id="editCategory" name="category" class="w-full px-4 py-2 border rounded">
                            <?php
