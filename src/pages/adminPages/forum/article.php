...
<html lang="en">
    ...
    <body class="font-serif text-gray-500"> 
                ...
                <nav class="flex flex-wrap items-center px-4"> 
                    ...
                    <div class="flex-1 hidden space-y-2 w-full lg:flex lg:items-center lg:justify-around lg:space-x-4 lg:space-y-0 lg:w-auto" data-name="nav-menu"> 
                        <div class="flex flex-col mr-auto lg:flex-row"> 
                            ...
                            <a href="#" class="text-gray-400 lg:p-4 py-2">Articles</a>
        ...
        <div class="w-11/12 mx-auto mt-10 min-h-screen">
            <h1 class="text-3xl font-bold mb-5">All Articles</h1>
            <table class="table-auto w-1/2 mx-auto bg-white rounded shadow-md">
                ...
                <tbody id="articleTable">
                    <?php
                        $allArticles = $db->selectAll("article");
                        foreach($allArticles as $articleInst){
                            $article = new Article($articleInst["id_article"]);
                            $article->displayAdmin();
                        }
                    ?>
                </tbody>
            </table>
        ...
        <div id="addModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
            <div class="bg-gray-400 rounded-lg shadow-lg w-3/4 md:w-1/2 max-h-[80vh] overflow-y-auto">
                <form id="addForm" class="p-6 space-y-4">
                    ...
                    <div id="categoriesInputContainer">
                        <div>
                    ...
                    <div class="flex  space-x-2">
                        <button id="dynamicAdd" type="button" class="px-4 py-2 bg-blue-500 text-white rounded">Add More Categories</button>
                    </div>
                    <div class="flex justify-end space-x-2">
        ...
        <script src="../../../assets/js/forum/articlesAdmin.js"></script>
    </body>
</html>
