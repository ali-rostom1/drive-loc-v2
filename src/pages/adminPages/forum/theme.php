    ...
    <body class="font-serif text-gray-500"> 
                ...
                <nav class="flex flex-wrap items-center px-4"> 
                    ...
                    <div class="flex-1 hidden lg:flex lg:items-center lg:justify-around lg:w-auto"> 
                        <div class="flex flex-col mr-auto lg:flex-row"> 
                            ...
                            <a href="#" class="text-gray-400 lg:p-4 py-2">Themes</a>
                            <a href="tag.php" class="hover:text-gray-400 lg:p-4 py-2 text-white">Tags</a>
                        </div>
        ...
        <div class="w-11/12 mx-auto mt-10 min-h-screen">
            <div class="flex justify-between items-center mb-5">
                ...
                <button onclick="document.getElementById('addModal').classList.remove('hidden')" class="bg-blue-500 text-white px-4 py-2 rounded">Add Theme</button>
            </div>
        ...
        <div id="addModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
            <div class="bg-gray-400 rounded-lg shadow-lg w-3/4 md:w-1/2">
                <form id="addForm" class="p-6 space-y-4">
                    <h2 class="text-xl font-bold">Add New Theme</h2>
                    <div>
                        <label for="addName" class="block text-sm font-medium">Theme Name</label>
                    ...
                    <div class="flex justify-end space-x-2">
                        ...
                        <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded">Add Theme</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div id="editModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
            <div class="bg-gray-400 rounded-lg shadow-lg w-3/4 md:w-1/2">
                <form id="editForm" class="p-6 space-y-4">
                    <h2 class="text-xl font-bold">Edit Theme</h2>
                    <input type="hidden" id="editId" name="id">
                    <div>
                        <label for="editName" class="block text-sm font-medium">Theme Name</label>
                    ...
                    <div>
                        ...
                        <textarea id="editDescription" name="description" class="w-full px-4 py-2 border rounded" required></textarea>
                    </div>
                    <div class="flex justify-end space-x-2">
        ...
        <script src="../../../assets/js/forum/themeAdmin.js"></script>
    </body>
</html>
