...
<html lang="en">
    ...
    <body class="font-serif text-gray-500"> 
                ...
                <nav class="flex flex-wrap items-center px-4"> 
                    ...
                    <div class="flex-1 hidden space-y-2 w-full lg:flex lg:items-center lg:justify-around lg:space-x-4 lg:space-y-0 lg:w-auto" data-name="nav-menu"> 
                        <div class="flex flex-col mr-auto lg:flex-row"> 
                            ...
                            <a href="#" class="text-gray-400 lg:p-4 py-2 ">Reservations</a>
                        </div>
        ...
        <div class="container mx-auto mt-10 min-h-screen">
            <h1 class="text-3xl font-bold mb-5">All Reservations</h1>
            <div class="overflow-x-auto">
                <table class="table-auto w-full lg:w-2/3 mx-auto border border-gray-300 text-left">
                    <thead>
                    ...
                    <tbody id="reservationTable">
                        <?php
                            ...
                            foreach($ids as $id){
                                ...
                                $reservation->displayReservationAdmin();
        ...
        <script src="../../assets/js/reservationAdmin.js"></script>
    </body>
</html>
